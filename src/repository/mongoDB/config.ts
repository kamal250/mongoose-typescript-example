  ...
  connectMongoDB() {
    try {
      if (this.MONGODB_USER && this.MONGODB_PASSWORD) {
        connect(
          `mongodb://${this.MONGODB_USER}:${this.MONGODB_PASSWORD}@${this.MONGODB_HOST}:${this.MONGODB_PORT}/${this.MONGODB_NAME}`,
          {
        ...
        connect(
          `mongodb://${this.MONGODB_HOST}:${this.MONGODB_PORT}/${this.MONGODB_NAME}`,
          {
            useUnifiedTopology: true,
            useNewUrlParser: true,
            useFindAndModify: false,
